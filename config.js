module.exports = {
  ...
  // i.e: "-discordbot foo" will trigger the command "foo",
  //      whereas "DiscordBot foo" will do nothing at all.
  prefix:  "~",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "MjcwMjg1NDc1MDc0Mjc3Mzg3.C116kA.h0Zdr3PLC7Lf3fuSPsqfHCPYhp4",
